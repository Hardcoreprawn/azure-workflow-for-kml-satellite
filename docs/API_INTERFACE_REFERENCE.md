...
AOI, successful imagery/transfer records matching reported counts, and complete
serverless post-processing. Batch successes are counted separately; the summary
