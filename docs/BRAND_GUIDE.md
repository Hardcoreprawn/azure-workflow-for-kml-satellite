...
The current globe SVG icon is retained — it communicates geospatial/satellite DNA directly. The fill colour changes from blue (`#58a6ff`) to **Canopex Emerald** (`#22c997`).

```html
<svg viewBox="0 0 24 24"><path fill="#22c997" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
```
...
| `--c-accent` | `#22c997` | `34, 201, 151` | **Canopex Emerald** — primary brand colour, links, CTAs, section labels |
...
| State | Colour | Notes |
|-------|--------|-------|
| Primary button hover | `#45ddb0` | Lighter emerald |
| Secondary button hover bg | `rgba(34,201,151,.1)` | 10% emerald tint |
| Auth button hover bg | `rgba(34,201,151,.15)` | 15% emerald tint |
| Accent tint (info callouts) | `rgba(34,201,151,.08–.1)` | Subtle background glow |
| Accent border | `rgba(34,201,151,.18–.25)` | Subtle border highlight |
...
| **Semantic green stays** | `--c-green` (`#3fb950`) is distinct from `--c-accent` (`#22c997`). Green = data/positive, emerald = UI/brand. |
...
- [x] Update `style.css` — replace hardcoded blue `rgba(88,166,255,...)` with emerald `rgba(34,201,151,...)`
- [x] Update `app.css` — replace hardcoded blue rgba values throughout
- [x] Create palette test page (`palette-test.html`)

### Phase 2: Name Change (to do)

- [ ] `website/index.html` — change `<title>`, all `TreeSight` text, meta tags, OG tags
- [ ] `website/app/index.html` — change `<title>`, all `TreeSight` text, meta tags, OG tags
- [ ] `website/privacy.html` — update brand name throughout
- [ ] `website/terms.html` — update brand name throughout
- [ ] `website/js/landing.js` — update `window.treesightBilling` namespace
- [ ] `website/js/app-shell.js` — update any `TreeSight` references
- [ ] Nav logo text — change "TreeSight" to "Canopex" in both HTML files
- [ ] Noscript banner — change "TreeSight requires JavaScript"
- [ ] `staticwebapp.config.json` — update CSP `connect-src` if domain changes
- [ ] Footer copyright — "© 2026 TreeSight" → "© 2026 Canopex"
