...
timeout. The #1479 storage race is fixed via #1487; acceptance evidence must
still come from a fresh-storage representative run (3 succeeded, 0 failed)
without pre-creating alternate output containers.
