...
| 2026-05-21 | [#874](https://github.com/Hardcoreprawn/azure-workflow-for-kml-satellite/pull/874) | [#863](https://github.com/Hardcoreprawn/azure-workflow-for-kml-satellite/issues/863)     | fix(pipeline): parallelise per-AOI enrichment loop — prevent activity timeout at 50+ AOIs (ThreadPoolExecutor, concurrency cap, error isolation, tests, TDD) |
