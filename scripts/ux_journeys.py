...
def print_report(page_results: list[PageResult], api_results: list[ApiResult]) -> bool:
    ...
    all_ok = all(r.ok for r in page_results) and all(r.ok for r in api_results)
...
def main() -> int:
    ...
    passed = print_report(page_results, api_results)
