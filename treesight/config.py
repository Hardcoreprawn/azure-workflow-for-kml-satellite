...
LOG_ANALYTICS_WORKSPACE_ID = _env("LOG_ANALYTICS_WORKSPACE_ID")
APPINSIGHTS_WORKSPACE_ID = _env("APPINSIGHTS_WORKSPACE_ID")
STATUS_RECOVERY_LOOKBACK_MINUTES = _env_int("STATUS_RECOVERY_LOOKBACK_MINUTES", 240)
