...
LOCAL_AUDIT_MAX_ARTIFACT_BYTES = 16 * 1024 * 1024
LOCAL_AUDIT_WORKER_CORRELATION_SECONDS = 0.1
LOCAL_AUDIT_MAX_RASTER_VALUES = 4 * 1024 * 1024
LOCAL_AUDIT_BOUNDS_TOLERANCE = 0.000001
...
E2E_PROGRESS_INTERVAL_SECONDS = 15
E2E_DEFAULT_CONCURRENCY = 3
...
try:
    DEFAULT_ENRICHMENT_FRAME_CONCURRENCY = int(os.environ.get("ENRICHMENT_FRAME_CONCURRENCY", "8"))
except (ValueError, TypeError):
    DEFAULT_ENRICHMENT_FRAME_CONCURRENCY = 8
...
MULTI_REGION_THRESHOLD_KM = 500.0
